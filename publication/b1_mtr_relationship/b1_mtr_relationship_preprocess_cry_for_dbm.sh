...
mkdir -m a=rwx $output/mtr_maps_native_space_nifti
mkdir -m a=rwx $output/mtr_maps_denoised_native_space_nifti
...
#for file in $tmp_subject_dir/*mt*; do mnc2nii $output/mtr_maps_native_space/$(basename -s .mnc $file)_mtr_map_imagemath.mnc $output/mtr_maps_native_space_nifti/$(basename -s .mnc $file)_mtr_map_imagemath.nii; done
#for file in $tmp_subject_dir/*mt*; do mnc2nii $output/mtr_maps_denoised_native_space/$(basename -s .mnc $file)_mtr_map_imagemath_denoised.mnc $output/mtr_maps_denoised_native_space_nifti/$(basename -s .mnc $file)_mtr_map_imagemath_denoised.nii; done
...
#fi
#for file in $tmp_subject_dir/*mt*; do echo ${basename}, $file, $output/mtr_maps_native_space_nifti/$(basename -s .mnc $file)_mtr_map_imagemath.nii >> $output/mtr_map_nifti_list_for_dbm.csv; done
#for file in $tmp_subject_dir/*mt*; do echo ${basename}, $file, $output/mtr_maps_denoised_native_space_nifti/$(basename -s .mnc $file)_mtr_map_imagemath_denoised.nii >> $output/mtr_map_denoised_nifti_list_for_dbm.csv; done
