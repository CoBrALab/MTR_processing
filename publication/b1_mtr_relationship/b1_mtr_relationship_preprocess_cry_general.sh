...
for file in $tmp_subject_dir/*mt*; do mincmath -zero -div $output/mtr_maps_mt1_space/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/$(basename -s .mnc $mt1)_mtr_map_imagemath_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space_normalized.mnc; done
for file in $tmp_subject_dir/*mt*; do mincmath -zero -div $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized/$(basename -s .mnc $mt1)_mtr_map_imagemath_denoised_eroded_mt1_space_normalized.mnc; done

#threshold the normalized MTR maps
for file in $tmp_subject_dir/*mt*; do ImageMath 3 $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized_thresholded/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space_normalized_tresh.mnc ReplaceVoxelValue $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space_normalized.mnc 3 10000 0; done
for file in $tmp_subject_dir/*mt*; do ImageMath 3 $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized_thresholded/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space_normalized_tresh.mnc ReplaceVoxelValue $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space_normalized.mnc 3 10000 0; done
