...
mkdir -m a=rwx $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized_thresholded
mkdir -m a=rwx $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized
mkdir -m a=rwx $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized_thresholded
...
#for file in $tmp_subject_dir/*mt*; do mincmath -mult $output/masks_native_space/${basename}_mask_nocsf_eroded.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space.mnc; done
#for file in $tmp_subject_dir/*mt*; do mincmath -mult $output/masks_native_space/${basename}_mask_nocsf_eroded.mnc $output/mtr_maps_mt1_space/$(basename -s .mnc $file)_mtr_map_imagemath_mt1_space.mnc $output/mtr_maps_mt1_space/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space.mnc; done

#normalize MTR maps (voxelwise division by mt1)
#for file in $tmp_subject_dir/*mt*; do mincmath -clobber -nan -div $output/mtr_maps_mt1_space/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/$(basename -s .mnc $mt1)_mtr_map_imagemath_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space_normalized.mnc; done
#for file in $tmp_subject_dir/*mt*; do mincmath -clobber -nan -div $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised/$(basename -s .mnc $mt1)_mtr_map_imagemath_denoised_eroded_mt1_space.mnc $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space_normalized.mnc; done

#threshold the normalized MTR maps
for file in $tmp_subject_dir/*mt*; do ImageMath 3 $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized_thresholded/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space_normalized_tresh.mnc ReplaceVoxelValue $output/mtr_maps_mt1_space/mtr_maps_mt1_space_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_eroded_mt1_space_normalized.mnc 1.1 10000 nan; done
for file in $tmp_subject_dir/*mt*; do ImageMath 3 $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized_thresholded/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space_normalized_tresh.mnc ReplaceVoxelValue $output/mtr_maps_mt1_space/mtr_maps_mt1_space_denoised_normalized/$(basename -s .mnc $file)_mtr_map_imagemath_denoised_eroded_mt1_space_normalized.mnc 1.1 10000 nan; done
